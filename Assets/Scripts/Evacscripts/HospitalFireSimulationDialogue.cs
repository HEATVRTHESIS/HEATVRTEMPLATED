    ...
    void Start()
    {
        ...
        if (dialogueSystem != null)
        {
            ...
            string[] simulationLines = new string[]
            {
                ...
                "I need to trust what my body is telling me. Every burn, every",
                "cough, every second in this heat matters.",
                "",
                "No arrows, no easy way out. I need to find exit signs, follow",
                "the emergency lights, and keep track of where I came from.",
                "",
                ...
                "",
                "Stay calm. Find that cloth. Control my breathing. Help who",
                "I can. Avoid the fire. Keep moving toward an exit.",
                "",
