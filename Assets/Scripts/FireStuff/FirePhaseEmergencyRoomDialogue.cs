...
/// <summary>
/// Fire safety training dialogue for the Emergency Room Department.
/// Teaches RACE and PASS acronyms for fire emergency response.
/// </summary>
public class FirePhaseEmergencyRoomDialogue : MonoBehaviour
{
    ...
    private IEnumerator StartDialogueAfterDelay()
    {
        ...
        if (dialogueSystem != null)
        {
            ...
            string[] fireTrainingLines = new string[]
            {
                ...
                "",
                "Emergency room fires can involve medical equipment, oxygen sources,",
                "and flammable materials. Always prioritize your safety",
                "and the safety of patients and staff above saving equipment.",
                "",
